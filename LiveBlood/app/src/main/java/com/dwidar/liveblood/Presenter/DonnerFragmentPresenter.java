...
import com.dwidar.liveblood.Model.ViewModel.DonnerFragmentModel;
import com.dwidar.liveblood.View.DonnerFragment;
import com.google.android.gms.maps.model.LatLng;

import java.util.List;

public class DonnerFragmentPresenter implements DonnerFragmentContract.IPresenter
{
    private DonnerFragmentContract.IView view;
    private DonnerFragmentContract.IModel model;
    private LatLng UserLocation;

    public DonnerFragmentPresenter(DonnerFragment v)
    {
        this.view = v;
        model = new DonnerFragmentModel(this);
    }
